...
urlpatterns = [
    ...
    re_path(r'^meetings/email-action/(?P<action>accepted|rejected)/(?P<token>[^/]+)/?$',
            notification.meeting_email_action, name='user_meeting_email_action'),
    ...
    re_path(r'^company/signup/?$', company_auth.company_signup, name='company_signup'),
    ...
    re_path(r'^marketing/campaigns/(?P<campaign_id>\d+)/sequences/classify-interest-level/?$', marketing_agent.classify_interest_level, name='marketing_classify_interest_level'),  # POST
    ...
    re_path(r'^exec-meeting/meetings/(?P<meeting_id>\d+)/notes/clear/?$', exec_meeting_api.meeting_notes_delete, name='exec_meeting_notes_delete'),  # DELETE
    ...
    re_path(r'^exec-meeting/meetings-filter-users/?$', exec_meeting_api.meeting_filter_users, name='exec_meeting_filter_users'),  # GET
