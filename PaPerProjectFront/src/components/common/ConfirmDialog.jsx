 ...
 *
 * Shared across all agent dashboards. Originally lived under
 * `components/operations/ConfirmDialog.jsx`; moved here so PM / Frontline /
 * HR / admin pages can drop the native browser confirm and use the same
 * styled modal the rest of the app uses.
 *
 * Props:
 *   open         boolean
