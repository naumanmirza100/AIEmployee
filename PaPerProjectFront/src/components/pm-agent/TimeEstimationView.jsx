    ...
    <div className="space-y-6">
      ...
      {loading && (
        <div className="flex items-center justify-center py-12">
          ...
          <span className="ml-3 text-white/55">AI is estimating task durations...</span>
        </div>
      )}
              ...
              <CardContent className="pt-6">
                <div className="flex items-center justify-center gap-8">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-white/55">Total Hours</div>
                  </div>
                  <div className="h-12 w-px bg-white/[0.05]" />
                  <div className="text-center">
                    <div className="text-3xl font-bold text-violet-300">{estimation.total_days || '—'}</div>
                    <div className="text-sm text-white/55">Total Days</div>
                  </div>
                  {estimation.confidence && (
                    <>
                      <div className="h-12 w-px bg-white/[0.05]" />
                      <div className="text-center">
                        <div className="text-3xl font-bold text-emerald-400">{estimation.confidence}%</div>
      ...
      {!loading && !estimation && (
        <div className="flex flex-col items-center justify-center py-20 text-white/40">
          <Timer className="w-12 h-12 mb-3 text-white/35" />
