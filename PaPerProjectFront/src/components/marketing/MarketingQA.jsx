                ...
                >
                  <div className="flex gap-2.5 items-center">
                    <Select value={inputMode} onValueChange={setInputMode}>
                      {/* Wrap ONLY the trigger — wrapping the whole <Select> made the
                          tooltip stay open over the dropdown options too. */}
                      <HoverTip tip="Choose Search or Graph for your prompt">
                        <SelectTrigger
